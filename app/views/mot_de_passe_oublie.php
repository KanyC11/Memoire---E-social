...
<head>
  ...
  <title>Mot de passe oublié - Don du Cœur</title>
...
<body class="h-screen flex">
  ...
  <div class="w-full md:w-1/2 flex flex-col justify-center items-center px-6">
    ...
    <form class="w-full max-w-sm space-y-4">
      ...
      <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded">Envoyer un lien</button>
      <p class="text-sm text-center"><a href="connexion.php" class="text-blue-600">Retour à la connexion</a></p>
    </form>
  </div>
</body>
</html>